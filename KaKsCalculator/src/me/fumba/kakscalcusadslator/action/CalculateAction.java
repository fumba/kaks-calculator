...
public class CalculateAction extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		/*
		 * if (pageName != null && studentService != null) { if
		 * (pageName.equals("login")) { result =
		 * studentService.findByLogin(userName, password); if
		 * (result.equals("LoginFailure")) { return "failure"; } else { return
		 * "success"; } } }
		 */
		return SUCCESS;
	}
