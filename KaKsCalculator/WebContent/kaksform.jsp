		...
		<div class="jumbotron">
			...
			<div class="row">
				...
				<s:form id="myForm" action="calculate" theme="bootstrap"
					...
					<fieldset>
						<s:textarea label="Original Sequence" name="originalSequence" cssClass="col-lg-12"
							rows="4" placeholder="" />

						<s:textarea label="Substituted Sequence" name="mutatedSequence" cssClass="col-lg-12"
							rows="4" placeholder="" />
